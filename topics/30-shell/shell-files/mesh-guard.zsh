...
# Cleanup: previous version of this file set `_MESH_PUBLIC_REPOS` as a
# module-level global. After upgrade, that array lingers in long-lived
# shells until restart. `unset` is a no-op when the variable is already
