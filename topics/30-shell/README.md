...
**Why a loader?** Every later topic (`10-languages`, `20-terminal-ux`, `50-git`, `60-web-stack`) writes its own fragment under `~/.bashrc.d/NN-<name>.sh` independently. The loader wires everything in the right order when the shell opens.
